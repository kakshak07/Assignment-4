        ...
        for u in tag_list:
            ...
            for v in tag_list:
                if word_list[k] in unidict:
                    emission=tagwdict[(word_list[k],v)]/word_of_tag[v]
                else:
                    emission=tagwdict[('_RARE_',v)]/word_of_tag[v]
                list_u_v_w=[]
                for w in tag_list:
                    list_u_v_w.append(((pi[k - 1,w,u] * word_of_tag[w,u,v]/word_of_tag[w,u]) * emission),w)
